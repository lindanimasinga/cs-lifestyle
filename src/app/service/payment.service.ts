...
export class PaymentService {
  ...
  generateHash(ozowPayment: OzowPaymentRequest) : string {
    ...
    var hash = ozowPayment.SiteCode+""+ozowPayment.CountryCode+""+ozowPayment.CurrencyCode+""+ozowPayment.Amount+""+ozowPayment.TransactionReference+""+ozowPayment.BankReference+""+ozowPayment.Customer+""+ozowPayment.CancelUrl+""+ozowPayment.ErrorUrl+""+ozowPayment.SuccessUrl+""+ozowPayment.NotifyUrl+""+ozowPayment.IsTest

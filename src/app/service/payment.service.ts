...
export class PaymentService {
  ...
  generatePaymentUrl(order: Order): Observable<string> {
    ...
    var ozowPayment: OzowPaymentRequest = {
      ...
      TransactionReference: PaymentService.generateReference(order.id, order.customerId),
      BankReference: "myFanPark Order",
  ...
  generateHash(ozowPayment: OzowPaymentRequest) : string {
    var hash = ozowPayment.SiteCode +""+ ozowPayment.CountryCode +""+ ozowPayment.CurrencyCode +""+
      ozowPayment.Amount +""+ ozowPayment.TransactionReference +""+ ozowPayment.BankReference +""+ ozowPayment.Customer +""+
        ozowPayment.CancelUrl +""+ ozowPayment.ErrorUrl +""+ ozowPayment.SuccessUrl +""+ ozowPayment.IsTest
